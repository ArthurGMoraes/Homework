...
public class DiscussaoService {
	...
	private DiscussaoDAO produtoDAO;

	public DiscussaoService() {
		try {
			produtoDAO = new DiscussaoDAO("produto.dat");
		} catch (IOException e) {
	...
	public Object add(Request request, Response response) {
		...
		Discussao produto = new Discussao(id, descricao, preco, quantidade, dataFabricacao, dataValidade);
	...
	public Object get(Request request, Response response) {
		...
		if (produto != null) {
            ...
            return "Discussao " + id + " não encontrado.";
        }
	...
	public Object update(Request request, Response response) {
        ...
        if (produto != null) {
            ...
            response.status(404); // 404 Not found
            return "Discussao não encontrado.";
        }
	...
	public Object getAll(Request request, Response response) {
		...
		for (Discussao produto : produtoDAO.getAll()) {
			returnValue.append("\n<produto>\n" + 
            		"\t<id>" + produto.getId() + "</id>\n" +
            		"\t<descricao>" + produto.getDescricao() + "</descricao>\n" +
            		"\t<preco>" + produto.getPreco() + "</preco>\n" +
