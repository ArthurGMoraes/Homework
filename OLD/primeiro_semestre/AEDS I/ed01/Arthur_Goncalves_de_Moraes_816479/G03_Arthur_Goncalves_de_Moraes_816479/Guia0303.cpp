...
---------------------------------------------- previsao de testes
v3.0.0
	Vai ler um arquvo chamado "Tarefa0301.txt", vai tentar armazenar os comandos dentro de "int comandos [ MAX_COMMANDS ];",e como não possui nada, ele vai ter 0 de largura
---------------------------------------------- historico
v3.0.0
