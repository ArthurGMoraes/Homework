...
---------------------------------------------- previsao de testes
v4.0.0
	Vai ler um arquvo chamado "Tarefa0301.txt", vai tentar armazenar os comandos dentro de "int comandos [ MAX_COMMANDS ];" e execultar os comandos para o robo. Mas como não possui nada, ele vai ter 0 de largura
---------------------------------------------- historico
v4.0.0
	Guia0304.cpp: In function 'int main()':
	Guia0304.cpp:245:1: error: 'quantidade' was not declared in this scope
	  245 | quantidade = robot->readCommands ( comandos, "Tarefa0301.txt" );
		  | ^~~~~~~~~~
		  
	resolvido:
		245 | int quantidade = robot->readCommands ( comandos, "Tarefa0301.txt" );
