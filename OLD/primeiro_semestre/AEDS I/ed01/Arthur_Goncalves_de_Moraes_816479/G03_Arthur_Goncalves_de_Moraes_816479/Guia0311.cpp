...
// world->set ( 4, 4, VWALL );
// world->set ( 4, 4, HWALL );
BRectangle(2,7,4,3);BRectangle(6,7,8,3);
// colocar um marcador no mundo
world->set ( 3, 2, BEEPER );world->set ( 3, 8, BEEPER );world->set ( 1, 5, BEEPER );
...
robot->fazerCoisa ( "Tarefa0311.txt" );
