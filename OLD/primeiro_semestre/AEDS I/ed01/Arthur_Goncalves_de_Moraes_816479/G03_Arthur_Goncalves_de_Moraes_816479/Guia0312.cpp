...
// world->set ( 4, 4, VWALL );
// world->set ( 4, 4, HWALL );
BHWall(2,7,8);BHWall(2,7,2);BHWall(5,7,7);BHWall(4,6,4);BHWall(4,5,6);world->set (3,7, HWALL );world->set (6,5, HWALL );
BVWall(1,3,8);BVWall(2,3,7);BVWall(7,3,7);BVWall(3,5,6);world->set (5,6, VWALL );world->set (4,7, VWALL );
// colocar um marcador no mundo
world->set ( 2, 3, BEEPER );
for (int Q=2;Q>0;Q--){world->set ( 4, 6, BEEPER );}
for (int Q=3;Q>0;Q--){world->set ( 5, 7, BEEPER );}
...
void fazerCoisa ( const char *fileName )
{
// definir dados
int action;
...
robot->fazerCoisa ( "Tarefa0312.txt" );
...
não funcionou de primeira, mas eram erros fajutos que eu consegui consertar rápidamente e funcionar na primeira execulsão
---------------------------------------------- previsao de testes
v12.0.0
