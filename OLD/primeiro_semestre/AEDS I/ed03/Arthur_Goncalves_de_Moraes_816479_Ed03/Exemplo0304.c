...
// definir dado
 int x = 0;
// identificar
 IO_id ( "EXEMPLO0304 - Method01 - v0.1" );
...
// definir dado
 ...
 int y = 0;
// identificar
 IO_id ( "EXEMPLO0304 - Method02 - v0.1" );
// ler do teclado
 x = IO_readint ( "Entrar com uma quantidade: " );
// repetir (x) vezes
...
// definir dado
 ...
 int y = 0;
// identificar
 IO_id ( "EXEMPLO0304 - Method03 - v0.1" );
// ler do teclado
 x = IO_readint ( "Entrar com uma quantidade: " );
// repetir (x) vezes
...
// definir dado
 ...
 int z = 0;
// identificar
 IO_id ( "EXEMPLO0304 - Method04 - v0.1" );
// ler do teclado
 x = IO_readint ( "Entrar com uma quantidade: " );
// repetir (x) vezes
...
// repetir até desejar parar
 ...
 {
 // identificar
 IO_id ( "EXEMPLO0304 - Programa - v0.1" );
