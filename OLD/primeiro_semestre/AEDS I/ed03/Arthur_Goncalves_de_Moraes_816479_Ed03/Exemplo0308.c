...
// definir dado
 int x = 0;
// identificar
 IO_id ( "EXEMPLO0308 - Method01 - v0.1" );
...
// definir dado
 ...
 int y = 0;
// identificar
 IO_id ( "EXEMPLO0308 - Method02 - v0.1" );
// ler do teclado
 x = IO_readint ( "Entrar com uma quantidade: " );
// repetir (x) vezes
...
// definir dado
 ...
 int y = 0;
// identificar
 IO_id ( "EXEMPLO0308 - Method03 - v0.1" );
// ler do teclado
 x = IO_readint ( "Entrar com uma quantidade: " );
// repetir (x) vezes
...
// definir dado
 ...
 int z = 0;
// identificar
 IO_id ( "EXEMPLO0308 - Method04 - v0.1" );
// ler do teclado
 x = IO_readint ( "Entrar com uma quantidade: " );
// repetir (x) vezes
...
// definir dado
 ...
 int z = 0;
// identificar
 IO_id ( "EXEMPLO0308 - Method05 - v0.1" );
// ler do teclado
 x = IO_readint ( "Entrar com uma quantidade: " );
// repetir (x) vezes
// inicio teste variacao
...
// definir dado
 ...
 int tamanho = 0;
// identificar
 IO_id ( "EXEMPLO0308 - Method06 - v0.1" );
// ler do teclado
...
// definir dado
 ...
 int tamanho = 0;
// identificar
 IO_id ( "EXEMPLO0308 - Method07 - v0.1" );
// ler do teclado
...
// definir dado
 ...
 int x = 0;
// identificar
 IO_id ( "EXEMPLO0308 - Method08 - v0.1" );
// ler do teclado
...
// repetir até desejar parar
 ...
 {
 // identificar
 IO_id ( "EXEMPLO0308 - Programa - v0.1" );
