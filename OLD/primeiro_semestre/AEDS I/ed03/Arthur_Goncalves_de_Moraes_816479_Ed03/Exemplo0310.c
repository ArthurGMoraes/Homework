...
// definir dado
 int x = 0;
// identificar
 IO_id ( "EXEMPLO0310 - Method01 - v0.1" );
...
// definir dado
 ...
 int y = 0;
// identificar
 IO_id ( "EXEMPLO0310 - Method02 - v0.1" );
// ler do teclado
 x = IO_readint ( "Entrar com uma quantidade: " );
// repetir (x) vezes
...
// definir dado
 ...
 int y = 0;
// identificar
 IO_id ( "EXEMPLO0310 - Method03 - v0.1" );
// ler do teclado
 x = IO_readint ( "Entrar com uma quantidade: " );
// repetir (x) vezes
...
// definir dado
 ...
 int z = 0;
// identificar
 IO_id ( "EXEMPLO0310 - Method04 - v0.1" );
// ler do teclado
 x = IO_readint ( "Entrar com uma quantidade: " );
// repetir (x) vezes
...
// definir dado
 ...
 int z = 0;
// identificar
 IO_id ( "EXEMPLO0310 - Method05 - v0.1" );
// ler do teclado
 x = IO_readint ( "Entrar com uma quantidade: " );
// repetir (x) vezes
// inicio teste variacao
...
// definir dado
 ...
 int tamanho = 0;
// identificar
 IO_id ( "EXEMPLO0310 - Method06 - v0.1" );
// ler do teclado
...
// definir dado
 ...
 int tamanho = 0;
// identificar
 IO_id ( "EXEMPLO0310 - Method07 - v0.1" );
// ler do teclado
...
// encerrar
 IO_pause ( "Apertar ENTER para continuar" ); // pause nao funciona somente nesse method
} // fim method07 ( )
...
// definir dado
 ...
 int x = 0;
// identificar
 IO_id ( "EXEMPLO0310 - Method08 - v0.1" );
// ler do teclado
...
// definir dado
 ...
 double x = 0;
// identificar
 IO_id ( "EXEMPLO0310 - Method09 - v0.1" );
// ler do teclado
...
// definir dado
 ...
 double x = 0;
// identificar
 IO_id ( "EXEMPLO0310 - Method10 - v0.1" );
// ler do teclado
 inferior = IO_readdouble ( "Limite inferior do intervalo : " );
...
// repetir até desejar parar
 ...
 {
 // identificar
 IO_id ( "EXEMPLO0310 - Programa - v0.1" );
