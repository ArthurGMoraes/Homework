...
// definir dado
 ...
 int controle = 0;
// identificar
 IO_id ( "EXEMPLO0406 - Method01 - v0.1" );
// ler do teclado
...
// definir dado
 ...
 int contador = 0;
// identificar
 IO_id ( "EXEMPLO0406 - Method02 - v0.1" );
// ler do teclado
 quantidade = IO_readint ( "Entrar com uma quantidade: " );
// repetir para a quantidade de vezes informada
 controle = 1;
...
// definir dado
 ...
 int contador = 0;
// identificar
 IO_id ( "EXEMPLO0406 - Method03 - v0.1" );
// ler do teclado
 quantidade = IO_readint ( "Entrar com uma quantidade: " );
// repetir para a quantidade de vezes informada
 controle = 1;
...
// definir dado
 ...
 int contador = 0;
// identificar
 IO_id ( "EXEMPLO0406 - Method04 - v0.1" );
// ler do teclado
 quantidade = IO_readint ( "Entrar com uma quantidade: " );
// repetir para a quantidade de vezes informada
 controle = 1;
...
// definir dado
 ...
 bool ok = false;
// identificar
 IO_id ( "EXEMPLO0406 - Method05 - v0.1" );
// ler do teclado
 quantidade = IO_readint ( "Entrar com uma quantidade: " );
// repetir para a quantidade de vezes informada
 controle = 1;
...
{
// identificar
 IO_id ( "EXEMPLO0406 - Method07 - v0.1" );
// encerrar
 IO_pause ( "Apertar ENTER para continuar" );
} // fim method07 ( )
/**
...
{
// identificar
 IO_id ( "EXEMPLO0406 - Method08 - v0.1" );
// encerrar
 IO_pause ( "Apertar ENTER para continuar" );
} // fim method08 ( )
/**
...
{
// identificar
 IO_id ( "EXEMPLO0406 - Method09 - v0.1" );
// encerrar
 IO_pause ( "Apertar ENTER para continuar" );
} // fim method09 ( )
/**
...
{
// identificar
 IO_id ( "EXEMPLO0406 - Method10 - v0.1" );
// encerrar
 IO_pause ( "Apertar ENTER para continuar" );
} // fim method10 ( )
/*
...
// repetir até desejar parar
 ...
 {
 // identificar
 IO_id ( "EXEMPLO0406 - Programa - v0.1" );
