...
// definir dado
 ...
 int controle = 0;
// identificar
 IO_id ( "EXEMPLO0410 - Method01 - v0.1" );
// ler do teclado
...
// definir dado
 ...
 int contador = 0;
// identificar
 IO_id ( "EXEMPLO0410 - Method02 - v0.1" );
// ler do teclado
 quantidade = IO_readint ( "Entrar com uma quantidade: " );
// repetir para a quantidade de vezes informada
 controle = 1;
...
// definir dado
 ...
 int contador = 0;
// identificar
 IO_id ( "EXEMPLO0410 - Method03 - v0.1" );
// ler do teclado
 quantidade = IO_readint ( "Entrar com uma quantidade: " );
// repetir para a quantidade de vezes informada
 controle = 1;
...
// definir dado
 ...
 int contador = 0;
// identificar
 IO_id ( "EXEMPLO0410 - Method04 - v0.1" );
// ler do teclado
 quantidade = IO_readint ( "Entrar com uma quantidade: " );
// repetir para a quantidade de vezes informada
 controle = 1;
...
// definir dado
 ...
 bool ok = false;
// identificar
 IO_id ( "EXEMPLO0410 - Method05 - v0.1" );
// ler do teclado
 quantidade = IO_readint ( "Entrar com uma quantidade: " );
// repetir para a quantidade de vezes informada
 controle = 1;
...
// definir dado
 ...
 int contador = 0;
// identificar
 IO_id ( "EXEMPLO0410 - Method06 - v0.1" );
// ler do teclado
...
// definir dado
 ...
 int contador = 0;
// identificar
 IO_id ( "EXEMPLO0410 - Method07 - v0.1" );
// ler do teclado
 palavra = IO_readstring ( "Entrar com uma palavra: " );
// determinar a quantidade de simbolos na palavra
 tamanho = strlen ( palavra );
...
// identificar
 IO_id ( "EXEMPLO0410 - Method08 - v0.1" );
// ler do teclado
 palavra = IO_readstring ( "Entrar com uma palavra: " );
// determinar a quantidade de simbolos na palavra
 tamanho = strlen ( palavra );
...
// definir dado
 ...
 int contador = 0;
// identificar
 IO_id ( "EXEMPLO0410 - Method09 - v0.1" );
// ler do teclado
...
// repetir até desejar parar
 ...
 {
 // identificar
 IO_id ( "EXEMPLO0410 - Programa - v0.1" );
