...
{
// identificar
 IO_id ( "EXEMPLO0710 - Method01 - v0.1" );
...
{
// identificar
 IO_id ( "EXEMPLO0710 - Method02 - v0.1" );
// executar o metodo auxiliar
 readInts ( "DADOS1.TXT" );
// encerrar
 IO_pause ( "Apertar ENTER para continuar" );
...
{
// identificar
 IO_id ( "EXEMPLO0710 - Method03 - v0.1" );
// executar o metodo auxiliar
...
{
// identificar
 IO_id ( "EXEMPLO0710 - Method04 - v0.1" );
// executar o metodo auxiliar
...
{
// identificar
 IO_id ( "EXEMPLO0710 - Method05 - v0.1" );
// executar o metodo auxiliar
...
{
// identificar
 IO_id ( "EXEMPLO0710 - Method06 - v0.1" );
// executar o metodo auxiliar
 readText ( "DADOS3.TXT" );
// encerrar
 IO_pause ( "Apertar ENTER para continuar" );
...
{
// identificar
 IO_id ( "EXEMPLO0710 - Method07 - v0.1" );
// executar o metodo auxiliar
...
{
// identificar
 IO_id ( "EXEMPLO0710 - Method08 - v0.1" );
// executar o metodo auxiliar
...
{
// identificar
 IO_id ( "EXEMPLO0710 - Method09 - v0.1" );
// executar o metodo auxiliar
...
// repetir até desejar parar
 ...
 {
 // identificar
 IO_id ( "EXEMPLO0710 - Programa - v0.1" );
 ...
 IO_println ( " 5 - Gravar em arquivo texto certa quantidade de valores (chars)" );
 IO_println ( " 6 - Ler de arquivo texto certa quantidade de valores (chars)" );
 IO_println ( " 7 - Copiar arquivo texto" );
 IO_println ( " 8 - Adicionar a um arquivo texto certa quantidade de valores" );
