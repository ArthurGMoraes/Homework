...
// definir dado
 int array [ ] = { 1, 2, 3, 4, 5 };
// identificar
 IO_id ( "EXEMPLO0805 - Method01 - v1.0" );
...
// definir dados
 ...
 int array [ n ];
// identificar
 IO_id ( "EXEMPLO0805 - Method02 - v1.0" );
// ler dados
...
// definir dados
 ...
 int array [ n ];
// identificar
 IO_id ( "EXEMPLO0805 - Method03 - v1.0" );
// ler dados
 readIntArray ( n, array );
// mostrar dados
 IO_printf ( "\n" );
...
// identificar
 IO_id ( "EXEMPLO0805 - Method04 - v1.0" );
// ler dados
...
// definir dados
 int n = 0; // quantidade de valores
// identificar
 IO_id ( "EXEMPLO0805 - Method05 - v1.0" );
// ler a quantidade de dados
 n = freadArraySize ( "ARRAY1.TXT" );
 if ( n <= 0 )
 {
...
// repetir até desejar parar
 ...
 {
 // identificar
 IO_id ( "EXEMPLO0805 - Programa - v1.0" );
