...
// definir dado
 int array [ ] = { 1, 2, 3, 4, 5 };
// identificar
 IO_id ( "EXEMPLO0810 - Method01 - v1.0" );
...
// definir dados
 ...
 int array [ n ];
// identificar
 IO_id ( "EXEMPLO0810 - Method02 - v1.0" );
// ler dados
...
// definir dados
 ...
 int array [ n ];
// identificar
 IO_id ( "EXEMPLO0810 - Method03 - v1.0" );
// ler dados
 readIntArray ( n, array );
// mostrar dados
 IO_printf ( "\n" );
...
// identificar
 IO_id ( "EXEMPLO0810 - Method04 - v1.0" );
// ler dados
...
// definir dados
 int n = 0; // quantidade de valores
// identificar
 IO_id ( "EXEMPLO0810 - Method05 - v1.0" );
// ler a quantidade de dados
 n = freadArraySize ( "ARRAY1.TXT" );
 if ( n <= 0 )
 {
...
// definir dados
 int n = 0; // quantidade de valores
// identificar
 IO_id ( "EXEMPLO0810 - Method06 - v1.0" );
// ler a quantidade de dados
 n = freadArraySize ( "ARRAY1.TXT" );
 if ( n <= 0 )
 {
...
// identificar
 IO_id ( "EXEMPLO0810 - Method07 - v1.0" );
// testar dados
 IO_println ( "\nArray1" );
...
// definir dados
 int n = 0; // quantidade de valores
// identificar
 IO_id ( "EXEMPLO0810 - Method08 - v1.0" );
// ler a quantidade de dados
 n = freadArraySize ( "ARRAY1.TXT" );
 if ( n <= 0 )
 {
...
// definir dados
 int n = 0; // quantidade de valores
// identificar
 IO_id ( "EXEMPLO0810 - Method09 - v1.0" );
// ler a quantidade de dados
 n = freadArraySize ( "ARRAY1.TXT" );
 if ( n <= 0 )
 {
...
// repetir até desejar parar
 ...
 {
 // identificar
 IO_id ( "EXEMPLO0810 - Programa - v1.0" );
