...
// identificar
 IO_id ( "EXEMPLO0901 - Method01 - v1.0" );
...
// definir dados
 ...
 int matrix [ n ][ n ];
// identificar
 IO_id ( "EXEMPLO0902 - Method02 - v1.0" );
// ler dados
...
// definir dados
 ...
 int columns = 0;
// identificar
 IO_id ( "EXEMPLO0903 - Method03 - v1.0" );
// ler dados
 rows = IO_readint ( "\nrows = " );
 columns = IO_readint ( "\ncolumns = " );
 IO_printf ( "\n" );
...
// definir dados
 ...
 int columns = 0;
// identificar
 IO_id ( "EXEMPLO0904 - Method04 - v1.0" );
// ler dados
...
// definir dados
 ...
 int columns = 0;
// identificar
 IO_id ( "EXEMPLO0905 - Method05 - v1.0" );
// ler dados
 rows = freadMatrixRows ( "MATRIX1.TXT" );
 columns = freadMatrixColumns ( "MATRIX1.TXT" );
...
// definir dados
 ...
 {7, 8, 9} };
// identificar
 IO_id ( "EXEMPLO0906 - Method06 - v1.0" );
// testar dados
 IO_println ( "\nMatrix1 " );
...
// definir dados
 ...
 {0, 1} };
// identificar
 IO_id ( "EXEMPLO0907 - Method07 - v1.0" );
// testar dados
 IO_println ( "\nMatrix1" );
 printIntMatrix( 2, 2, matrix1 );
...
// definir dados
 ...
 {0, 1} };
// identificar
 IO_id ( "EXEMPLO0908 - Method08 - v1.0" );
// testar dados
 IO_println ( "\nMatrix1" );
 printIntMatrix( 2, 2, matrix1 );
 IO_println ( "\nMatrix2" );
...
// definir dados
 ...
 {0, 0} };
// identificar
 IO_id ( "EXEMPLO0909 - Method09 - v1.0" );
// testar dados
 IO_println ( "\nMatrix1" );
 printIntMatrix( 2, 2, matrix1 );
 IO_println ( "\nMatrix2" );
...
// definir dados
 ...
 {0, 0} };
// identificar
 IO_id ( "EXEMPLO0910 - Method10 - v1.0" );
// testar produto
 IO_println ( "\nMatrix1" );
 printIntMatrix( 2, 2, matrix1 );
 IO_println ( "\nMatrix2" );
