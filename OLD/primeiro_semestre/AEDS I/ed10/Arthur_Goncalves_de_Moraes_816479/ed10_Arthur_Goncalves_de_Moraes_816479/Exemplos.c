...
// definir dados
 int_Array array;
// identificar
 IO_id ( "EXEMPLO1003 - Method03 - v1.0" );
// ler dados
 array = IO_readintArray ( );
// testar a existência de dados
 if ( array.data )
...
// identificar
 IO_id ( "EXEMPLO1010 - Method10 - v1.0" );
// ler dados
...
// repetir até desejar parar
 ...
 IO_println ( " 6 - Reservar espaco para arranjo bidimensional com inteiros" );
