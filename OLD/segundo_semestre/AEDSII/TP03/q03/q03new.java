...
class q03new{
    ...
    public static int n = 0;
        ...
        public static void inserir(Jogador c){
            if (n < 250){
                for (int i = n; i > 0; i--) {
                        l[i] = l[i - 1];
                }
        ...
        public static void imprimir(){
            ...
            for (int i = 0; i < n; i++, j++){
                array[i] = (" ## " + l[i].nome + " ## " + l[i].altura + " ## " + l[i].peso + " ## " + l[i].anoNascimento + " ## " + l[i].universidade + " ## " + l[i].cidadeNascimento + " ## " + l[i].estadoNascimento.trim() + " ##");
            }
